...
input_seg_file = "0802/series3_cropped_seg.npy"
input_clusters = "0802/object_clusters8_separated.csv"
output_dir = "0802"
...
object_cluster_dict = {
    row["object_index"]: row["cluster"] for i, row in props_df.iterrows()
}
...
output_filename = f"{basename}_colored_clustertitle.png"
